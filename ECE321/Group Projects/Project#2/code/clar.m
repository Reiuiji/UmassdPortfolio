% clar.m :Simulate playing a clarinet
%
% Author: Daniel Noyes
% Checker: Jenny Doan
%
...
Eight_G = [harmonics(G,0.25,N,ones(1,N),contour) genrest(0.08)];
Half_Eb = [harmonics(Eb,0.9,N,ones(1,N),contour) genrest(0.1)];
Eight_F = [harmonics(F,0.25,N,ones(1,N),contour) genrest(0.08)];
Half_D =  [harmonics(D,0.9 ,N,ones(1,N),contour) genrest(0.1)];

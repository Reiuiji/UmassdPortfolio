...
int main()
{
	...
	printf("|----------------------------|-----------|-----------|-----------|-------|\n");
	while(fscanf(DATA,"%s %d %d %d %d",student[ARRAY_LIM].name,&student[ARRAY_LIM].midterm[0],&student[ARRAY_LIM].midterm[1],&student[ARRAY_LIM].midterm[2],&student[ARRAY_LIM].final) == 5)
	{
